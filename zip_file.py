"""Python script to zip the directory containing different files in it."""
...
def zip_file_reports(compressed_file):
    ...
    try:
        with ZipFile(compressed_file, 'w') as zipped_folder:
            for folder_name, sub_folders, file_names in os.walk('reports'):
