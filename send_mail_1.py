"""Python Script to send an email having zip file as an attachment"""
...
temp_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), './reports')
...
msg['To'] = 'ankitaliya321@gmail.com'
